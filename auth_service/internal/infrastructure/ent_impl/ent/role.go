...
type Role struct {
	...
	Permissions []enum.Permission `json:"permissions,omitempty"`
...
// was not loaded in eager-loading.
func (e RoleEdges) AuthClientsOrErr() ([]*AuthClient, error) {
	if e.loadedTypes[1] {
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case role.FieldID, role.FieldClientType:
...
// QueryAuthClients queries the "auth_clients" edge of the Role entity.
func (r *Role) QueryAuthClients() *AuthClientQuery {
	return NewRoleClient(r.config).QueryAuthClients(r)
}
