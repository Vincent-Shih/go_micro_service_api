...
func (uc *UserCreate) SetPasswordFailTimes(i int) *UserCreate {
	uc.mutation.SetPasswordFailTimes(i)
	return uc
}
...
func (uc *UserCreate) SetAuthClientsID(id int64) *UserCreate {
	uc.mutation.SetAuthClientsID(id)
	return uc
}

// SetNillableAuthClientsID sets the "auth_clients" edge to the AuthClient entity by ID if the given value is not nil.
func (uc *UserCreate) SetNillableAuthClientsID(id *int64) *UserCreate {
	if id != nil {
		uc = uc.SetAuthClientsID(*id)
	}
	return uc
}

// SetAuthClients sets the "auth_clients" edge to the AuthClient entity.
func (uc *UserCreate) SetAuthClients(a *AuthClient) *UserCreate {
	return uc.SetAuthClientsID(a.ID)
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.PasswordFailTimes(); !ok {
		return &ValidationError{Name: "password_fail_times", err: errors.New(`ent: missing required field "User.password_fail_times"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.PasswordFailTimes(); ok {
		_spec.SetField(user.FieldPasswordFailTimes, field.TypeInt, value)
		_node.PasswordFailTimes = value
	}
	if value, ok := uc.mutation.Status(); ok {
		_spec.SetField(user.FieldStatus, field.TypeInt, value)
		_node.Status = value
	}
	if nodes := uc.mutation.AuthClientsIDs(); len(nodes) > 0 {
		...
		_node.auth_client_users = &nodes[0]
...
// SetPasswordFailTimes sets the "password_fail_times" field.
func (u *UserUpsert) SetPasswordFailTimes(v int) *UserUpsert {
	u.Set(user.FieldPasswordFailTimes, v)
	return u
}

// UpdatePasswordFailTimes sets the "password_fail_times" field to the value that was provided on create.
func (u *UserUpsert) UpdatePasswordFailTimes() *UserUpsert {
	u.SetExcluded(user.FieldPasswordFailTimes)
	return u
}

// AddPasswordFailTimes adds v to the "password_fail_times" field.
func (u *UserUpsert) AddPasswordFailTimes(v int) *UserUpsert {
	u.Add(user.FieldPasswordFailTimes, v)
	return u
}
...
// SetPasswordFailTimes sets the "password_fail_times" field.
func (u *UserUpsertOne) SetPasswordFailTimes(v int) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetPasswordFailTimes(v)
	})
}

// AddPasswordFailTimes adds v to the "password_fail_times" field.
func (u *UserUpsertOne) AddPasswordFailTimes(v int) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.AddPasswordFailTimes(v)
	})
}

// UpdatePasswordFailTimes sets the "password_fail_times" field to the value that was provided on create.
func (u *UserUpsertOne) UpdatePasswordFailTimes() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdatePasswordFailTimes()
	})
}
...
// SetPasswordFailTimes sets the "password_fail_times" field.
func (u *UserUpsertBulk) SetPasswordFailTimes(v int) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetPasswordFailTimes(v)
	})
}
...
// AddPasswordFailTimes adds v to the "password_fail_times" field.
func (u *UserUpsertBulk) AddPasswordFailTimes(v int) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.AddPasswordFailTimes(v)
	})
}
...
// UpdatePasswordFailTimes sets the "password_fail_times" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdatePasswordFailTimes() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdatePasswordFailTimes()
	})
}
