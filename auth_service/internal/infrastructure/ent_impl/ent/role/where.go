...
func ClientType(v int) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldClientType, v))
}
...
func ClientTypeEQ(v int) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldClientType, v))
}

// ClientTypeNEQ applies the NEQ predicate on the "client_type" field.
func ClientTypeNEQ(v int) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldClientType, v))
}

// ClientTypeIn applies the In predicate on the "client_type" field.
func ClientTypeIn(vs ...int) predicate.Role {
	return predicate.Role(sql.FieldIn(FieldClientType, vs...))
}

// ClientTypeNotIn applies the NotIn predicate on the "client_type" field.
func ClientTypeNotIn(vs ...int) predicate.Role {
	return predicate.Role(sql.FieldNotIn(FieldClientType, vs...))
}

// ClientTypeGT applies the GT predicate on the "client_type" field.
func ClientTypeGT(v int) predicate.Role {
	return predicate.Role(sql.FieldGT(FieldClientType, v))
}

// ClientTypeGTE applies the GTE predicate on the "client_type" field.
func ClientTypeGTE(v int) predicate.Role {
	return predicate.Role(sql.FieldGTE(FieldClientType, v))
}

// ClientTypeLT applies the LT predicate on the "client_type" field.
func ClientTypeLT(v int) predicate.Role {
	return predicate.Role(sql.FieldLT(FieldClientType, v))
}

// ClientTypeLTE applies the LTE predicate on the "client_type" field.
func ClientTypeLTE(v int) predicate.Role {
	return predicate.Role(sql.FieldLTE(FieldClientType, v))
}
...
func HasAuthClients() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAuthClientsWith(preds ...predicate.AuthClient) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
